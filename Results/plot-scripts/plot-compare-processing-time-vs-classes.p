...
system "egrep '^[0-9]+ 100 ' 3classes/results.txt | awk '{print $4 \" \" $5 \" \" $9}' >/tmp/plot-data.txt"
system "egrep '^[0-9]+ 100 ' 5classes/results.txt | awk '{print $4 \" \" $5 \" \" $9}' >>/tmp/plot-data.txt"
system "egrep '^[0-9]+ 100 ' 7classes/results.txt | awk '{print $4 \" \" $5 \" \" $9}' >>/tmp/plot-data.txt"
system "egrep '^[0-9]+ 100 ' 9classes/results.txt | awk '{print $4 \" \" $5 \" \" $9}' >>/tmp/plot-data.txt"
